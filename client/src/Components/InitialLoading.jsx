...
export default function InitialLoading() {
    const { initialLoading } = useContext(ContextApi)
    return (
        <>

            <svg style={{ background: "transparent" }} xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24">
                <g fill="none" stroke="#c4c5c5" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
